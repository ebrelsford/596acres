...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookPhotoPlugin.width'
        db.add_column('cmsplugin_facebookphotoplugin', 'width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookPhotoPlugin.width'
        db.delete_column('cmsplugin_facebookphotoplugin', 'width')
