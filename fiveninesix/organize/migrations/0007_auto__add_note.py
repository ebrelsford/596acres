...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Note'
        db.create_table('organize_note', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('noter', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('lot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lots.Lot'])),
        ))
        db.send_create_signal('organize', ['Note'])


    def backwards(self, orm):
        
        # Deleting model 'Note'
        db.delete_table('organize_note')
