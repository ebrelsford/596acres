...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.group_has_access'
        db.add_column('lots_lot', 'group_has_access', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lot.group_has_access'
        db.delete_column('lots_lot', 'group_has_access')
