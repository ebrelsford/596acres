...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OwnerContact.jurisdiction'
        db.add_column('lots_ownercontact', 'jurisdiction', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'OwnerContact.notes'
        db.add_column('lots_ownercontact', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OwnerContact.jurisdiction'
        db.delete_column('lots_ownercontact', 'jurisdiction')

        # Deleting field 'OwnerContact.notes'
        db.delete_column('lots_ownercontact', 'notes')
