...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.community_district'
        db.add_column('lots_lot', 'community_district', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Adding field 'Lot.city_council_district'
        db.add_column('lots_lot', 'city_council_district', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Lot.council_district'
        db.add_column('lots_lot', 'council_district', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Adding field 'Lot.council'
        db.add_column('lots_lot', 'council', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Deleting field 'Lot.community_district'
        db.delete_column('lots_lot', 'community_district')

        # Deleting field 'Lot.city_council_district'
        db.delete_column('lots_lot', 'city_council_district')
