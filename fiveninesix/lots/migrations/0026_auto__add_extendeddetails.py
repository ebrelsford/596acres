...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExtendedDetails'
        db.create_table('lots_extendeddetails', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lot', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lots.Lot'], unique=True)),
            ('parcel_name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('number_of_buildings', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('primary_use', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('rpad_description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('is_waterfront', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('is_urban_renewal', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('current_uses', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('has_open_petroleum_spill', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('agency_codes', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('historic_district', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('landmark', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal('lots', ['ExtendedDetails'])


    def backwards(self, orm):
        
        # Deleting model 'ExtendedDetails'
        db.delete_table('lots_extendeddetails')
