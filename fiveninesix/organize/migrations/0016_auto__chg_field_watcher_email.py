...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Watcher.email'
        db.alter_column('organize_watcher', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))


    def backwards(self, orm):
        
        # Changing field 'Watcher.email'
        db.alter_column('organize_watcher', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
