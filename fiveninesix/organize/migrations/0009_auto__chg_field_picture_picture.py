...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Picture.picture'
        db.alter_column('organize_picture', 'picture', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Picture.picture'
        db.alter_column('organize_picture', 'picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
