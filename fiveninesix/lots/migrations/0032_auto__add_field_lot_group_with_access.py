...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.group_with_access'
        db.add_column('lots_lot', 'group_with_access', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['organize.Organizer']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lot.group_with_access'
        db.delete_column('lots_lot', 'group_with_access_id')
