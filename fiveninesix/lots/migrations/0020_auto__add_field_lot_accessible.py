...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.accessible'
        db.add_column('lots_lot', 'accessible', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lot.accessible'
        db.delete_column('lots_lot', 'accessible')
