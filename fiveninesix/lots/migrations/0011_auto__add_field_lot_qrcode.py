...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.qrcode'
        db.add_column('lots_lot', 'qrcode', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lot.qrcode'
        db.delete_column('lots_lot', 'qrcode')
