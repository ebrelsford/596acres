...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.parent_lot'
        db.add_column('lots_lot', 'parent_lot', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['lots.Lot']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Lot.parent_lot'
        db.delete_column('lots_lot', 'parent_lot_id')
