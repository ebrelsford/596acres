...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lots_ownercontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lots.Owner'])),
        ...
        db.send_create_signal('lots', ['OwnerContact'])

        # Adding field 'Lot.owner_contact'
        db.add_column('lots_lot', 'owner_contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lots.OwnerContact'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'OwnerContact'
        db.delete_table('lots_ownercontact')

        # Deleting field 'Lot.owner_contact'
        db.delete_column('lots_lot', 'owner_contact_id')
