...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.sandy_dropoff_site'
        db.add_column('lots_lot', 'sandy_dropoff_site', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Lot.sandy_distribution_site'
        db.add_column('lots_lot', 'sandy_distribution_site', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lot.sandy_dropoff_site'
        db.delete_column('lots_lot', 'sandy_dropoff_site')

        # Deleting field 'Lot.sandy_distribution_site'
        db.delete_column('lots_lot', 'sandy_distribution_site')
