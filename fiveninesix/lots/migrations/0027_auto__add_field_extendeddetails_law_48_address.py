...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExtendedDetails.law_48_address'
        db.add_column('lots_extendeddetails', 'law_48_address', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExtendedDetails.law_48_address'
        db.delete_column('lots_extendeddetails', 'law_48_address')
