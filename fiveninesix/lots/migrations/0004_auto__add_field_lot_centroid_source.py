...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.centroid_source'
        db.add_column('lots_lot', 'centroid_source', self.gf('django.db.models.fields.CharField')(max_length=32, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lot.centroid_source'
        db.delete_column('lots_lot', 'centroid_source')
