...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.external_source'
        db.add_column('photos_photo', 'external_source', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.external_source'
        db.delete_column('photos_photo', 'external_source')
