...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PhotoAlbum.cover'
        db.add_column('photos_photoalbum', 'cover', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], null=True, blank=True), keep_default=False)

        # Adding field 'PhotoAlbum.created_time'
        db.add_column('photos_photoalbum', 'created_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PhotoAlbum.updated_time'
        db.add_column('photos_photoalbum', 'updated_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Photo.created_time'
        db.add_column('photos_photo', 'created_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Photo.updated_time'
        db.add_column('photos_photo', 'updated_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Photo.position'
        db.add_column('photos_photo', 'position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PhotoAlbum.cover'
        db.delete_column('photos_photoalbum', 'cover_id')

        # Deleting field 'PhotoAlbum.created_time'
        db.delete_column('photos_photoalbum', 'created_time')

        # Deleting field 'PhotoAlbum.updated_time'
        db.delete_column('photos_photoalbum', 'updated_time')

        # Deleting field 'PhotoAlbum.lot'
        db.delete_column('photos_photoalbum', 'lot_id')

        # Deleting field 'Photo.created_time'
        db.delete_column('photos_photo', 'created_time')

        # Deleting field 'Photo.updated_time'
        db.delete_column('photos_photo', 'updated_time')

        # Deleting field 'Photo.position'
        db.delete_column('photos_photo', 'position')
