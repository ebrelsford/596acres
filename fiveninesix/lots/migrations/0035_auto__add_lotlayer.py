...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LotLayer'
        db.create_table('lots_lotlayer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('lots', ['LotLayer'])

        # Adding M2M table for field lots on 'LotLayer'
        db.create_table('lots_lotlayer_lots', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lotlayer', models.ForeignKey(orm['lots.lotlayer'], null=False)),
            ('lot', models.ForeignKey(orm['lots.lot'], null=False))
        ))
        db.create_unique('lots_lotlayer_lots', ['lotlayer_id', 'lot_id'])


    def backwards(self, orm):
        
        # Deleting model 'LotLayer'
        db.delete_table('lots_lotlayer')

        # Removing M2M table for field lots on 'LotLayer'
        db.delete_table('lots_lotlayer_lots')
    ...
    models = {
        ...
        'organize.organizer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lots.Lot']", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
