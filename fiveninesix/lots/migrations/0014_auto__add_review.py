...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lots_review', (
            ...
            ('reviewed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('street_accessible', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('needs_further_review', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('nearby_lots', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('lots', ['Review'])


    def backwards(self, orm):
        
        # Deleting model 'Review'
        db.delete_table('lots_review')
