...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Watcher.added'
        db.add_column('organize_watcher', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 9, 26, 12, 11, 14, 634159), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Watcher.added'
        db.delete_column('organize_watcher', 'added')
