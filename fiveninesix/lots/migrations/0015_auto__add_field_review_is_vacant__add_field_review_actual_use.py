...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.actual_use'
        db.add_column('lots_review', 'actual_use', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Review.actual_use'
        db.delete_column('lots_review', 'actual_use')
    ...
    models = {
        ...
        'lots.review': {
            ...
            'street_accessible': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        }
    }
