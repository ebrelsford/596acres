...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.area_acres'
        db.add_column('lots_lot', 'area_acres', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lot.area_acres'
        db.delete_column('lots_lot', 'area_acres')
