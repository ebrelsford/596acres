...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.should_be_imported'
        db.add_column('lots_review', 'should_be_imported', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Review.imported'
        db.add_column('lots_review', 'imported', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.should_be_imported'
        db.delete_column('lots_review', 'should_be_imported')

        # Deleting field 'Review.imported'
        db.delete_column('lots_review', 'imported')
