...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExtendedDetails.jurisdiction_code'
        db.add_column('lots_extendeddetails', 'jurisdiction_code', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Adding field 'ExtendedDetails.jurisdiction_description'
        db.add_column('lots_extendeddetails', 'jurisdiction_description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExtendedDetails.jurisdiction_code'
        db.delete_column('lots_extendeddetails', 'jurisdiction_code')

        # Deleting field 'ExtendedDetails.jurisdiction_description'
        db.delete_column('lots_extendeddetails', 'jurisdiction_description')
