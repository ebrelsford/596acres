...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizer.lot'
        db.add_column('organize_organizer', 'lot', self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_lot', null=True, to=orm['lots.Lot']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizer.lot'
        db.delete_column('organize_organizer', 'lot_id')
