...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Review.street_accessible'
        db.delete_column('lots_review', 'street_accessible')

        # Deleting field 'Review.is_vacant'
        db.delete_column('lots_review', 'is_vacant')

        # Adding field 'Review.in_use'
        db.add_column('lots_review', 'in_use', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Review.accessible'
        db.add_column('lots_review', 'accessible', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Review.street_accessible'
        db.add_column('lots_review', 'street_accessible', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Review.is_vacant'
        db.add_column('lots_review', 'is_vacant', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Review.in_use'
        db.delete_column('lots_review', 'in_use')

        # Deleting field 'Review.accessible'
        db.delete_column('lots_review', 'accessible')
    ...
    models = {
        ...
        'lots.review': {
            ...
            'reviewed': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
