...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Review.reviewed' to 'Review.added'
        db.rename_column('lots_review', 'reviewed', 'added')


    def backwards(self, orm):
        
        # Rename field 'Review.added' to 'Review.reviewed'
        db.rename_column('lots_review', 'added', 'reviewed')
