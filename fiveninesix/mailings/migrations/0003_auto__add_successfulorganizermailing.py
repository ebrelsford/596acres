...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SuccessfulOrganizerMailing'
        db.create_table('mailings_successfulorganizermailing', (
            ('mailing_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mailings.Mailing'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('mailings', ['SuccessfulOrganizerMailing'])


    def backwards(self, orm):
        
        # Deleting model 'SuccessfulOrganizerMailing'
        db.delete_table('mailings_successfulorganizermailing')
    ...
    models = {
        ...
        'mailings.successfulorganizermailing': {
            'Meta': {'object_name': 'SuccessfulOrganizerMailing', '_ormbases': ['mailings.Mailing']},
            'mailing_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['mailings.Mailing']", 'unique': 'True', 'primary_key': 'True'})
        },
