...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Owner.person'
        db.add_column('lots_owner', 'person', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Owner.site'
        db.add_column('lots_owner', 'site', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Owner.notes'
        db.add_column('lots_owner', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Owner.person'
        db.delete_column('lots_owner', 'person')

        # Deleting field 'Owner.site'
        db.delete_column('lots_owner', 'site')

        # Deleting field 'Owner.notes'
        db.delete_column('lots_owner', 'notes')
