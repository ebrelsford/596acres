...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizer.added'
        db.add_column('organize_organizer', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 11, 21, 12, 56, 51, 669139), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizer.added'
        db.delete_column('organize_organizer', 'added')
