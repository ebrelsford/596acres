...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.hpd_plans'
        db.add_column('lots_review', 'hpd_plans', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Review.hpd_plans_details'
        db.add_column('lots_review', 'hpd_plans_details', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.hpd_plans'
        db.delete_column('lots_review', 'hpd_plans')

        # Deleting field 'Review.hpd_plans_details'
        db.delete_column('lots_review', 'hpd_plans_details')
