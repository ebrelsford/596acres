...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Watcher.email_hash'
        db.add_column('organize_watcher', 'email_hash', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Watcher.email_hash'
        db.delete_column('organize_watcher', 'email_hash')
